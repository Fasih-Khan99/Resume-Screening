...
Resume Screening is an intelligent system that ranks job applicants based on their resumes using Natural Language Processing (NLP) and Machine Learning techniques. 
This project helps HR teams automatically match candidates to job requirements and evaluate qualifications with improved speed and accuracy.
